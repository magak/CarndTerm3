        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
        	...
        	// Main car's localization Data
          	...
          	egoVehicle.ProcessInputData(
          			car_x, car_y, car_s, car_d, car_yaw, car_speed,
					previous_path_x_orig, previous_path_y_orig,
          	...
          	{
          		prevDist = calHelper::distance(next_x_vals[previous_path_x.size()-1],
														   next_y_vals[previous_path_x.size()-1],
														   next_x_vals[previous_path_x.size()-2],
														   next_y_vals[previous_path_x.size()-2]);
          	}
